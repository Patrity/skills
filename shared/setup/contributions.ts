import type { BaseAxis, BaseSchema, BundleFiles, CliManifest, SectionDef } from '../types/setup'
import { splitSnippet } from './sections'
import { renderPlaceholders, type PlaceholderVars } from './placeholders'
import type { Contribution } from './render'
