...
The pattern list is the whole policy, so add your project's own (`*.pem`, `service-account.json`,
...
value, because the reminder arrives in the last moment where the context that learned the lesson still
