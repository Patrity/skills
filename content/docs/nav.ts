...
export const docsNav: DocEntry[] = [
  { slug: 'start-here', title: 'Start here', file: 'start-here.md', group: 'Start', description: 'The whole setup into a project, from a browser or a terminal.' },
  { slug: 'philosophy', title: 'Philosophy', file: 'philosophy.md', group: 'Start', description: 'The choices the setup makes, and the bundle behind each one.' },
  ...
  { slug: 'hooks-and-settings', title: 'Hooks and settings', file: 'hooks-and-settings.md', group: 'Reference', description: 'The settings files, hook scripts, and the files the tool manages for you.' },
