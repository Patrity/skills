...
export const docsNav: DocEntry[] = [
  { slug: 'start-here', title: 'Start here', file: 'start-here.md', group: 'Start', description: 'Get the whole setup into a project, from the web or from a terminal.' },
  ...
  { slug: 'bundle-structure', title: 'Bundle structure', file: 'bundle-structure.md', group: 'Reference', description: 'What goes where inside skills/<slug>/.' },
  { slug: 'frontmatter', title: 'Frontmatter reference', file: 'frontmatter.md', group: 'Reference', description: 'Every README key, required or optional.' },
