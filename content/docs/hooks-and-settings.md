...
`permissions.allow` it finds is routed to `settings.local.json`, where permissions belong.
...
## settings.local.json stays on one machine
...
## hooks/ holds what the settings point at
